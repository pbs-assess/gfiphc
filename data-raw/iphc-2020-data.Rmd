...
```{r standardornot}
sets_2018 <- filter(hooks_with_bait$set_counts,
                    year == 2018)
...
filter(hooks_with_bait$set_counts, year == 2018, lon > -124)$standard
nrow(filter(hooks_with_bait$set_counts, year == 2018, lon > -124))
...
points(lat~lon,
       data = filter(hooks_with_bait$set_counts,
                     year == 2019),
       col="darkgreen",
       pch = 0)
...
```{r checkearly}
filter(hooks_with_bait$set_counts,
