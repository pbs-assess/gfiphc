...
Also do the same but with all non-halibut data, and save as
`non-halibut-data-2020.xlsx` and export as .csv in Excel. Importantly, this file
(but not the first one) contains the numbers of observed hooks, needed in our calculations.
...
hook_details <- dplyr::select(counts_raw,
                        year = Year,
                        station = Station,
                        hooksRetr = HooksRetrieved,
                        hooksObs = HooksObserved)
