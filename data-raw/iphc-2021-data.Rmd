...
TODO: check if standard grid appears later.
...
For 2021 we have all as Standard Grid, which probably needs correcting in the
next section. TODO revise
```{r purpose}
...
So they are all classified as standard. Now need to understand if this is
correct.
...
curious ones are the 2021 ones way in in the inlets that are no longer flagged as
non-standard (they were originally in 2020); in fact none are.
...
stations are non-standard in 2018 or 2021:
...
the non-standard 2018 stations.
