...
These are IPHC names that are not given in `iphc-spp-names.csv` (ignoring
obvious ones that are listed in the function):
...
Then redoing those above commands with updated code gives:
