...
stations_only_2018 <- filter(stations_in_2018,
...
# stations_only_2018 %>% arrange(lat) %>% select(station, lat, lon) %>% as.data.frame()
stations_only_2018

# Confirm they are all usable:
expect_equal(stations_only_2018$usable, rep("Y", nrow(stations_only_2018)))
```
...
plot_iphc_map(stations_only_2018,
              sp_short_name = NULL,
              years = 2018,
