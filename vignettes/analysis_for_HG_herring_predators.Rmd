...
get_combined_species <- function(sp_vec){
  ...
  combined_species$set_counts <- rowwise(all_sp_set_counts) %>%
    mutate(N_it_sum = sum(c_across(contains("N_it...")), na.rm = TRUE),
           N_it20_sum = sum(c_across(contains("N_it20...")), na.rm = TRUE),
