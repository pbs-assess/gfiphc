...
herring_HG_area <- AoI       # now just use what Rowan did
plot_BC()
PBSmapping::addPolys(herring_HG_area, col = "pink")
# plot_BC(add = TRUE)
```

TODO: Draws over some islands - don't worry for now.

Or try plotting stations first:
```{r stationsfirst}
