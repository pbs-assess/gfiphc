...
Even quicker version -- all the most recent data are now downloaded, analysed
...
the whole coast. Series AB does not include the west coast of Vancouver Island.
...
In the above movie you see that the spatial coverage of sets changed in 2018,
