...
For 2021 note that there is sporadic coverage off the west coast of Vancouver
...
Island. For 2021 there are also six stations that were never previously fished
and so we call these non-standard -- see brief mention in the README and
[iphc-2021-data.pdf](../data-raw/iphc-2021-data.pdf) for full details.
...
![IPHC-stations-movie-1995-2021.gif](IPHC-stations-movie-1995-2021.gif).
...
would have been in a Rockfish Conservation Area according to the grid pattern).
...
## Expanded survey grid in 2018, 2020, and 2021

In the above movie and panel plot you see that the spatial coverage of sets changed in 2018,
2020, and 2021 due to the expanded survey grid that year that involved sets at extra stations:
...
standard stations (see [iphc-2020-data.pdf](../data-raw/iphc-2020-data.pdf) and
[iphc-2021-data.pdf](../data-raw/iphc-2021-data.pdf)
...
So we use `filter(..., standard == "Y", usable == "Y")` for analyses (to also include
