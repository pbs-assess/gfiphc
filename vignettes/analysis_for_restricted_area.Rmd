...
2021 (and 2018 and 2020) had expanded (non-standard) stations, which are shown as crosses:
```{r area2021, results = FALSE}
plot_BC(main = "All 2021 stations")
...
![IPHC-stations-HG-area-movie-1995-2021.gif](IPHC-stations-HG-area-movie-1995-2021.gif).
