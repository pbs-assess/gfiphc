...
# This adds `in_area` column (whether or not the location is in the area of
# interest) and an EID for each set (unique event identifier needed for PBSmapping::findPolys)
...
HERE - check this then start multiple species one.
