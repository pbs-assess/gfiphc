...
does all the extraction, calculations, and plotting just from the species name
(see examples in `analysis_for_HG_herring_predators.Rmd`). This vignette shows
...
repeat this vignette for your species of interest.
...
plot_IPHC_ser_four_panels(ser_E_and_F,
                          ...
                          sp = sp)
```
For 2020 (but not really 2018) incorrectly including the non-standard stations
reduces the 2020 value somewhat. Interestingly, 2019 bootstrapped values change
very slightly also, because of less random numbers now used for 2018
calculations (this motivates changing the default to 10,000 samples).
<!-- Andy has saved: -->
