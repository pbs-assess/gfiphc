...
works for users with access to the GFBio database at the Pacific Biological
Station, or if you have the retrieved data cached locally (in default directory `all-species-data/`.
...
for(sp in sp_vec){      # increment these to test, done up to number shown
  iphc_get_calc_plot_full(sp,
                          cached_data = FALSE,    # TRUE if data already saved
                          cached_results = FALSE, # TRUE if results already saved
                          print_sp_name = FALSE,
